...
public class UserDaoImpl implements UserDao {
	...
	public boolean adduser(User user) throws SQLException{
		...
		try{
        PreparedStatement preparedStmt = connection.prepareStatement("insert into user_personal_info(firstname,dob,email,lastname) values(?,?,?,?)");
        preparedStmt.setString(1, user.getFirstname());
        preparedStmt.setString(2, user.getDob());
	...
	public boolean updateUser(User user) throws SQLException{
		Connection connection = db.getConnection();
		try{
        PreparedStatement preparedStmt = connection.prepareStatement("update user set firstname=?,dob=? where id=?");
        preparedStmt.setString(1, user.getFirstname());
        preparedStmt.setString(2, user.getDob());
